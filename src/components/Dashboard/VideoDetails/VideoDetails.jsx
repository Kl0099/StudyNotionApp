...
const VideoDetails = () => {
  ...
  useEffect(() => {
    ...
    console.log("course SectionData  : ", courseSectionData);
  }, [videoData, courseSectionData]);
  ...
  // how to go into next video
  const goToNextVideo = () => {
    const currentSectionIndex = courseSectionData.findIndex(
      (data) => data._id === sectionId
    );
    const numberOfSubSection =
      courseSectionData[currentSectionIndex].subSection.length;
    //currnet subsection index
    ...
    <div className="flex flex-col gap-5 text-white">
      {!videoData ? (
        ...
        >
          <BigPlayButton
            position="center"
            onclick={() => setVideoStart(!videoStart)}
          />
